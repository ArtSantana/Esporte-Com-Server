...
function GoPosition()
{
    goPositions.to($("#b1"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[0][0], top: matrizes[0].presetPositions.matrixGoTeamA[0][1]})
        .to($("#b2"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[1][0], top: matrizes[0].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#b3"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[2][0], top: matrizes[0].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#b4"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[3][0], top: matrizes[0].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#b5"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[4][0], top: matrizes[0].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#b6"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[5][0], top: matrizes[0].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#b7"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[6][0], top: matrizes[0].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#b8"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[7][0], top: matrizes[0].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#b9"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[8][0], top: matrizes[0].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#b10"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[9][0], top: matrizes[0].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#b11"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[10][0], top: matrizes[0].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")

        .to($("#r1"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[1][0], top: matrizes[0].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r2"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[1][0], top: matrizes[0].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r3"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[2][0], top: matrizes[0].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#r4"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[3][0], top: matrizes[0].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#r5"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[4][0], top: matrizes[0].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#r6"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[5][0], top: matrizes[0].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#r7"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[6][0], top: matrizes[0].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#r8"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[7][0], top: matrizes[0].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#r9"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[8][0], top: matrizes[0].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#r10"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[9][0], top: matrizes[0].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#r11"), 0.5, {left: matrizes[0].presetPositions.matrixGoTeamA[10][0], top: matrizes[0].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")
}
...
{
    goPositions2.to($("#b1"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[0][0], top: matrizes[1].presetPositions.matrixGoTeamA[0][1]})
        .to($("#b2"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[1][0], top: matrizes[1].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#b3"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[2][0], top: matrizes[1].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#b4"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[3][0], top: matrizes[1].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#b5"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[4][0], top: matrizes[1].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#b6"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[5][0], top: matrizes[1].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#b7"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[6][0], top: matrizes[1].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#b8"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[7][0], top: matrizes[1].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#b9"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[8][0], top: matrizes[1].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#b10"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[9][0], top: matrizes[1].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#b11"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[10][0], top: matrizes[1].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")

        .to($("#r1"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[1][0], top: matrizes[1].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r2"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[1][0], top: matrizes[1].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r3"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[2][0], top: matrizes[1].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#r4"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[3][0], top: matrizes[1].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#r5"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[4][0], top: matrizes[1].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#r6"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[5][0], top: matrizes[1].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#r7"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[6][0], top: matrizes[1].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#r8"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[7][0], top: matrizes[1].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#r9"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[8][0], top: matrizes[1].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#r10"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[9][0], top: matrizes[1].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#r11"), 0.5, {left: matrizes[1].presetPositions.matrixGoTeamA[10][0], top: matrizes[1].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")
}
...
{
    goPositions3.to($("#b1"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[0][0], top: matrizes[2].presetPositions.matrixGoTeamA[0][1]})
        .to($("#b2"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[1][0], top: matrizes[2].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#b3"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[2][0], top: matrizes[2].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#b4"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[3][0], top: matrizes[2].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#b5"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[4][0], top: matrizes[2].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#b6"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[5][0], top: matrizes[2].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#b7"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[6][0], top: matrizes[2].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#b8"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[7][0], top: matrizes[2].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#b9"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[8][0], top: matrizes[2].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#b10"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[9][0], top: matrizes[2].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#b11"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[10][0], top: matrizes[2].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")

        .to($("#r1"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[1][0], top: matrizes[2].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r2"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[1][0], top: matrizes[2].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r3"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[2][0], top: matrizes[2].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#r4"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[3][0], top: matrizes[2].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#r5"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[4][0], top: matrizes[2].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#r6"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[5][0], top: matrizes[2].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#r7"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[6][0], top: matrizes[2].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#r8"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[7][0], top: matrizes[2].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#r9"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[8][0], top: matrizes[2].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#r10"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[9][0], top: matrizes[2].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#r11"), 0.5, {left: matrizes[2].presetPositions.matrixGoTeamA[10][0], top: matrizes[2].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")
}
...
{
    goPositions4.to($("#b1"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[0][0], top: matrizes[3].presetPositions.matrixGoTeamA[0][1]})
        .to($("#b2"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[1][0], top: matrizes[3].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#b3"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[2][0], top: matrizes[3].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#b4"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[3][0], top: matrizes[3].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#b5"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[4][0], top: matrizes[3].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#b6"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[5][0], top: matrizes[3].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#b7"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[6][0], top: matrizes[3].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#b8"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[7][0], top: matrizes[3].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#b9"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[8][0], top: matrizes[3].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#b10"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[9][0], top: matrizes[3].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#b11"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[10][0], top: matrizes[3].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")

        .to($("#r1"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[1][0], top: matrizes[3].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r2"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[1][0], top: matrizes[3].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r3"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[2][0], top: matrizes[3].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#r4"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[3][0], top: matrizes[3].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#r5"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[4][0], top: matrizes[3].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#r6"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[5][0], top: matrizes[3].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#r7"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[6][0], top: matrizes[3].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#r8"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[7][0], top: matrizes[3].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#r9"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[8][0], top: matrizes[3].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#r10"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[9][0], top: matrizes[3].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#r11"), 0.5, {left: matrizes[3].presetPositions.matrixGoTeamA[10][0], top: matrizes[3].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")
}
...
{
    goPositions5.to($("#b1"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[0][0], top: matrizes[4].presetPositions.matrixGoTeamA[0][1]})
        .to($("#b2"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[1][0], top: matrizes[4].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#b3"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[2][0], top: matrizes[4].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#b4"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[3][0], top: matrizes[4].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#b5"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[4][0], top: matrizes[4].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#b6"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[5][0], top: matrizes[4].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#b7"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[6][0], top: matrizes[4].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#b8"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[7][0], top: matrizes[4].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#b9"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[8][0], top: matrizes[4].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#b10"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[9][0], top: matrizes[4].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#b11"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[10][0], top: matrizes[4].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")

        .to($("#r1"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[1][0], top: matrizes[4].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r2"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[1][0], top: matrizes[4].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r3"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[2][0], top: matrizes[4].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#r4"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[3][0], top: matrizes[4].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#r5"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[4][0], top: matrizes[4].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#r6"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[5][0], top: matrizes[4].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#r7"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[6][0], top: matrizes[4].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#r8"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[7][0], top: matrizes[4].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#r9"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[8][0], top: matrizes[4].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#r10"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[9][0], top: matrizes[4].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#r11"), 0.5, {left: matrizes[4].presetPositions.matrixGoTeamA[10][0], top: matrizes[4].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")
}
...
{
    goPositions6.to($("#b1"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[0][0], top: matrizes[5].presetPositions.matrixGoTeamA[0][1]})
        .to($("#b2"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[1][0], top: matrizes[5].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#b3"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[2][0], top: matrizes[5].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#b4"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[3][0], top: matrizes[5].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#b5"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[4][0], top: matrizes[5].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#b6"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[5][0], top: matrizes[5].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#b7"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[6][0], top: matrizes[5].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#b8"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[7][0], top: matrizes[5].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#b9"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[8][0], top: matrizes[5].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#b10"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[9][0], top: matrizes[5].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#b11"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[10][0], top: matrizes[5].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")

        .to($("#r1"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[1][0], top: matrizes[5].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r2"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[1][0], top: matrizes[5].presetPositions.matrixGoTeamA[1][1]}, "-=0.5")
        .to($("#r3"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[2][0], top: matrizes[5].presetPositions.matrixGoTeamA[2][1]}, "-=0.5")
        .to($("#r4"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[3][0], top: matrizes[5].presetPositions.matrixGoTeamA[3][1]}, "-=0.5")
        .to($("#r5"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[4][0], top: matrizes[5].presetPositions.matrixGoTeamA[4][1]}, "-=0.5")
        .to($("#r6"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[5][0], top: matrizes[5].presetPositions.matrixGoTeamA[5][1]}, "-=0.5")
        .to($("#r7"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[6][0], top: matrizes[5].presetPositions.matrixGoTeamA[6][1]}, "-=0.5")
        .to($("#r8"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[7][0], top: matrizes[5].presetPositions.matrixGoTeamA[7][1]}, "-=0.5")
        .to($("#r9"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[8][0], top: matrizes[5].presetPositions.matrixGoTeamA[8][1]}, "-=0.5")
        .to($("#r10"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[9][0], top: matrizes[5].presetPositions.matrixGoTeamA[9][1]}, "-=0.5")
        .to($("#r11"), 0.5, {left: matrizes[5].presetPositions.matrixGoTeamA[10][0], top: matrizes[5].presetPositions.matrixGoTeamA[10][1]}, "-=0.5")
}
