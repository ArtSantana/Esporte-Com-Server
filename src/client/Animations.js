...
function GoPosition()
{
    goPositions.to($("#b1"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[0][0], top: matrizes[0].presetPositions.matrixGoTeamA[0][1]})
        ...
        .to($("#r1"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[1][0], top: matrizes[0].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r2"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[1][0], top: matrizes[0].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r3"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[2][0], top: matrizes[0].presetPositions.matrixGoTeamA[2][1]}, "-=1.5")
        .to($("#r4"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[3][0], top: matrizes[0].presetPositions.matrixGoTeamA[3][1]}, "-=1.5")
        .to($("#r5"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[4][0], top: matrizes[0].presetPositions.matrixGoTeamA[4][1]}, "-=1.5")
        .to($("#r6"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[5][0], top: matrizes[0].presetPositions.matrixGoTeamA[5][1]}, "-=1.5")
        .to($("#r7"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[6][0], top: matrizes[0].presetPositions.matrixGoTeamA[6][1]}, "-=1.5")
        .to($("#r8"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[7][0], top: matrizes[0].presetPositions.matrixGoTeamA[7][1]}, "-=1.5")
        .to($("#r9"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[8][0], top: matrizes[0].presetPositions.matrixGoTeamA[8][1]}, "-=1.5")
        .to($("#r10"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[9][0], top: matrizes[0].presetPositions.matrixGoTeamA[9][1]}, "-=1.5")
        .to($("#r11"), 1.5, {left: matrizes[0].presetPositions.matrixGoTeamA[10][0], top: matrizes[0].presetPositions.matrixGoTeamA[10][1]}, "-=1.5")
}
...
function GoPosition2()
{
    goPositions2.to($("#b1"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[0][0], top: matrizes[1].presetPositions.matrixGoTeamA[0][1]})
        ...
        .to($("#r1"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[1][0], top: matrizes[1].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r2"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[1][0], top: matrizes[1].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r3"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[2][0], top: matrizes[1].presetPositions.matrixGoTeamA[2][1]}, "-=1.5")
        .to($("#r4"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[3][0], top: matrizes[1].presetPositions.matrixGoTeamA[3][1]}, "-=1.5")
        .to($("#r5"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[4][0], top: matrizes[1].presetPositions.matrixGoTeamA[4][1]}, "-=1.5")
        .to($("#r6"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[5][0], top: matrizes[1].presetPositions.matrixGoTeamA[5][1]}, "-=1.5")
        .to($("#r7"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[6][0], top: matrizes[1].presetPositions.matrixGoTeamA[6][1]}, "-=1.5")
        .to($("#r8"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[7][0], top: matrizes[1].presetPositions.matrixGoTeamA[7][1]}, "-=1.5")
        .to($("#r9"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[8][0], top: matrizes[1].presetPositions.matrixGoTeamA[8][1]}, "-=1.5")
        .to($("#r10"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[9][0], top: matrizes[1].presetPositions.matrixGoTeamA[9][1]}, "-=1.5")
        .to($("#r11"), 1.5, {left: matrizes[1].presetPositions.matrixGoTeamA[10][0], top: matrizes[1].presetPositions.matrixGoTeamA[10][1]}, "-=1.5")
}
...
function GoPosition3()
{
    goPositions3.to($("#b1"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[0][0], top: matrizes[2].presetPositions.matrixGoTeamA[0][1]})
        ...
        .to($("#r1"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[1][0], top: matrizes[2].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r2"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[1][0], top: matrizes[2].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r3"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[2][0], top: matrizes[2].presetPositions.matrixGoTeamA[2][1]}, "-=1.5")
        .to($("#r4"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[3][0], top: matrizes[2].presetPositions.matrixGoTeamA[3][1]}, "-=1.5")
        .to($("#r5"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[4][0], top: matrizes[2].presetPositions.matrixGoTeamA[4][1]}, "-=1.5")
        .to($("#r6"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[5][0], top: matrizes[2].presetPositions.matrixGoTeamA[5][1]}, "-=1.5")
        .to($("#r7"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[6][0], top: matrizes[2].presetPositions.matrixGoTeamA[6][1]}, "-=1.5")
        .to($("#r8"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[7][0], top: matrizes[2].presetPositions.matrixGoTeamA[7][1]}, "-=1.5")
        .to($("#r9"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[8][0], top: matrizes[2].presetPositions.matrixGoTeamA[8][1]}, "-=1.5")
        .to($("#r10"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[9][0], top: matrizes[2].presetPositions.matrixGoTeamA[9][1]}, "-=1.5")
        .to($("#r11"), 1.5, {left: matrizes[2].presetPositions.matrixGoTeamA[10][0], top: matrizes[2].presetPositions.matrixGoTeamA[10][1]}, "-=1.5")
}
...
function GoPosition4()
{
    goPositions4.to($("#b1"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[0][0], top: matrizes[3].presetPositions.matrixGoTeamA[0][1]})
        ...
        .to($("#r1"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[1][0], top: matrizes[3].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r2"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[1][0], top: matrizes[3].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r3"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[2][0], top: matrizes[3].presetPositions.matrixGoTeamA[2][1]}, "-=1.5")
        .to($("#r4"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[3][0], top: matrizes[3].presetPositions.matrixGoTeamA[3][1]}, "-=1.5")
        .to($("#r5"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[4][0], top: matrizes[3].presetPositions.matrixGoTeamA[4][1]}, "-=1.5")
        .to($("#r6"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[5][0], top: matrizes[3].presetPositions.matrixGoTeamA[5][1]}, "-=1.5")
        .to($("#r7"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[6][0], top: matrizes[3].presetPositions.matrixGoTeamA[6][1]}, "-=1.5")
        .to($("#r8"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[7][0], top: matrizes[3].presetPositions.matrixGoTeamA[7][1]}, "-=1.5")
        .to($("#r9"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[8][0], top: matrizes[3].presetPositions.matrixGoTeamA[8][1]}, "-=1.5")
        .to($("#r10"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[9][0], top: matrizes[3].presetPositions.matrixGoTeamA[9][1]}, "-=1.5")
        .to($("#r11"), 1.5, {left: matrizes[3].presetPositions.matrixGoTeamA[10][0], top: matrizes[3].presetPositions.matrixGoTeamA[10][1]}, "-=1.5")
}
...
function GoPosition5()
{
    goPositions5.to($("#b1"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[0][0], top: matrizes[4].presetPositions.matrixGoTeamA[0][1]})
        ...
        .to($("#r1"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[1][0], top: matrizes[4].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r2"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[1][0], top: matrizes[4].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r3"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[2][0], top: matrizes[4].presetPositions.matrixGoTeamA[2][1]}, "-=1.5")
        .to($("#r4"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[3][0], top: matrizes[4].presetPositions.matrixGoTeamA[3][1]}, "-=1.5")
        .to($("#r5"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[4][0], top: matrizes[4].presetPositions.matrixGoTeamA[4][1]}, "-=1.5")
        .to($("#r6"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[5][0], top: matrizes[4].presetPositions.matrixGoTeamA[5][1]}, "-=1.5")
        .to($("#r7"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[6][0], top: matrizes[4].presetPositions.matrixGoTeamA[6][1]}, "-=1.5")
        .to($("#r8"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[7][0], top: matrizes[4].presetPositions.matrixGoTeamA[7][1]}, "-=1.5")
        .to($("#r9"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[8][0], top: matrizes[4].presetPositions.matrixGoTeamA[8][1]}, "-=1.5")
        .to($("#r10"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[9][0], top: matrizes[4].presetPositions.matrixGoTeamA[9][1]}, "-=1.5")
        .to($("#r11"), 1.5, {left: matrizes[4].presetPositions.matrixGoTeamA[10][0], top: matrizes[4].presetPositions.matrixGoTeamA[10][1]}, "-=1.5")
}
...
function GoPosition6()
{
    goPositions6.to($("#b1"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[0][0], top: matrizes[5].presetPositions.matrixGoTeamA[0][1]})
        ...
        .to($("#r1"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[1][0], top: matrizes[5].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r2"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[1][0], top: matrizes[5].presetPositions.matrixGoTeamA[1][1]}, "-=1.5")
        .to($("#r3"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[2][0], top: matrizes[5].presetPositions.matrixGoTeamA[2][1]}, "-=1.5")
        .to($("#r4"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[3][0], top: matrizes[5].presetPositions.matrixGoTeamA[3][1]}, "-=1.5")
        .to($("#r5"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[4][0], top: matrizes[5].presetPositions.matrixGoTeamA[4][1]}, "-=1.5")
        .to($("#r6"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[5][0], top: matrizes[5].presetPositions.matrixGoTeamA[5][1]}, "-=1.5")
        .to($("#r7"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[6][0], top: matrizes[5].presetPositions.matrixGoTeamA[6][1]}, "-=1.5")
        .to($("#r8"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[7][0], top: matrizes[5].presetPositions.matrixGoTeamA[7][1]}, "-=1.5")
        .to($("#r9"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[8][0], top: matrizes[5].presetPositions.matrixGoTeamA[8][1]}, "-=1.5")
        .to($("#r10"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[9][0], top: matrizes[5].presetPositions.matrixGoTeamA[9][1]}, "-=1.5")
        .to($("#r11"), 1.5, {left: matrizes[5].presetPositions.matrixGoTeamA[10][0], top: matrizes[5].presetPositions.matrixGoTeamA[10][1]}, "-=1.5")
}
